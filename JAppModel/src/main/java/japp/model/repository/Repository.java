...
public abstract class Repository<T extends Entity, U> implements Singletonable {
    ...
    @SuppressWarnings("hiding")
    protected <T> TypedQuery<T> createTypedQuery(final Class<T> domainClass, final String queryString,
    ...
    public PageResult<Map<String, Object>> search(final List<String> selections, final String fromQueryString,
            final String sortQueryString, final int firstResult, final int maxResults, final Object... parameters) {
        return search(selections, fromQueryString, null, sortQueryString, firstResult, maxResults, parameters);
    }

    public PageResult<Map<String, Object>> search(final List<String> selections, final String fromQueryString,
            final String criteriaQuery, final String sortQueryString, final int firstResult, final int maxResults,
            final Object... parameters) {
        ...
        final TypedQuery<Object[]> searchTypedQuery = createTypedQuery(Object[].class, "SELECT " + selectionsQueryString
                + " FROM " + fromQueryString + compiledCriteriaQueryString + compiledSortQueryString, parameters);
    ...
    @SuppressWarnings("unchecked")
    public PageResult<Map<String, Object>> search(final List<SelectionWrapper<?>> selectionWrappers,
            final Predicate predicate, final List<Order> orders, final int firstResult, final int maxResults) {
    ...
    public PageResult<Map<String, Object>> deepSearch(final List<String> selections, final String fromQueryString,
            final String criteriaQuery, final String sortQueryString, final int firstResult, final int maxResults,
            final Object... parameters) {
    ...
    public PageResult<Map<String, Object>> deepSearch(final List<String> selections, final String fromQueryString,
            final List<String> criteriaQuery, final String sortQueryString, final int firstResult, final int maxResults,
            final Object... parameters) {
    ...
    protected List<Map<String, Object>> convertToMappedResultList(final List<String> aliases,
    ...
    private String getQueryFragment(final List<String> query, final Reference<Integer> start, final int index,
