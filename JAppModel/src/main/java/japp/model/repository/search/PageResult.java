...
public class PageResult<T> implements Serializable {
    ...
    public PageResult(final List<T> data, final long total, final long totalFiltered, final int firstResult,
        ...
        this.page = this.data.isEmpty() ? 1
                : this.pageTotal - (int) Math.ceil((double) (totalFiltered - firstResult) / maxResults) + 1;
    }
