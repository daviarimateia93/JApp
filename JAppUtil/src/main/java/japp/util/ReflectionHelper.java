...
public abstract class ReflectionHelper {
    ...
    public static boolean isNull(final Field field, final Object instance)
    ...
    public static boolean isNumeric(final Field field, final Object instance)
            throws IllegalArgumentException, IllegalAccessException {
        return (Short.class.isAssignableFrom(field.getType()) || Integer.class.isAssignableFrom(field.getType())
                || Long.class.isAssignableFrom(field.getType()) || Float.class.isAssignableFrom(field.getType())
                || Double.class.isAssignableFrom(field.getType())) || isNumeric(field.get(instance));
    }

    public static boolean isNumeric(final Object object) {
        return object instanceof Short || object instanceof Integer || object instanceof Long || object instanceof Float
                || object instanceof Double || object instanceof BigDecimal || object instanceof BigInteger;
    }

    public static boolean isBoolean(final Field field, final Object instance)
            throws IllegalArgumentException, IllegalAccessException {
    ...
    public static boolean isCharacter(final Field field, final Object instance)
            throws IllegalArgumentException, IllegalAccessException {
    ...
    public static boolean isString(final Field field, final Object instance)
            throws IllegalArgumentException, IllegalAccessException {
    ...
    public static boolean isList(final Field field, final Object instance)
            throws IllegalArgumentException, IllegalAccessException {
    ...
    public static boolean isSet(final Field field, final Object instance)
            throws IllegalArgumentException, IllegalAccessException {
    ...
    public static boolean isMap(final Field field, final Object instance)
            throws IllegalArgumentException, IllegalAccessException {
    ...
    public static boolean isEnum(final Field field, final Object instance)
            throws IllegalArgumentException, IllegalAccessException {
    ...
    public static boolean isDate(final Field field, final Object instance)
            throws IllegalArgumentException, IllegalAccessException {
    ...
    public static boolean isBigDecimal(final Field field, final Object instance)
            throws IllegalArgumentException, IllegalAccessException {
    ...
    public static boolean isCollection(final Field field, final Object instance)
            throws IllegalArgumentException, IllegalAccessException {
    ...
    public static boolean isPrimitive(final Field field, final Object instance)
            throws IllegalArgumentException, IllegalAccessException {
        return (isNumeric(field, instance) || isString(field, instance) || isCharacter(field, instance)
                || isBoolean(field, instance)) && !isArray(field);
    }
    ...
    public static <T> Constructor<T> getConstructor(final Class<T> type, final Class<?>... parameterClasses)
            throws NoSuchMethodException, SecurityException {
        return type.getDeclaredConstructor(parameterClasses);
    }

    public static <T> T newInstance(final Class<T> type, final Class<?>[] parameterClasses, final Object... parameters)
    ...
    public static <T> T newInstance(final Class<T> type) throws NoSuchMethodException, SecurityException,
            InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        return newInstance(type, new Class<?>[] {}, new Object[] {});
    }

    public static <T> T forceNewInstance(final Class<T> type, final Class<?>[] parameterClasses,
            final Object... parameters) throws NoSuchMethodException, SecurityException, InstantiationException,
    ...
    public static <T> T forceNewInstance(final Class<T> type) throws NoSuchMethodException, SecurityException,
            InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
