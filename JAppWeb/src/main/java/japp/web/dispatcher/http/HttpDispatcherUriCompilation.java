...
public class HttpDispatcherUriCompilation extends UriCompilation {
	...
	public HttpDispatcherUriCompilation(final RequestMapping requestMapping, final Float score, final Boolean valid, final String pattern, final String compiledPattern, final Map<String, String> variables) {
