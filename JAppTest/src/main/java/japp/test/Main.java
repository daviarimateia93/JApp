...
public class Main {
    ...
    public static void main2(final String[] args) {
        String pattern = "/rest/{anything}".replaceAll("\\{(.+?)\\}",
                "([a-zA-Z0-9\\\\\\%\\\\\\-\\\\\\.\\\\\\_\\\\\\~\\\\\\:\\\\\\/\\\\\\?\\\\\\#\\\\\\[\\\\\\]\\\\\\@\\\\\\!\\\\\\$\\\\\\&\\\\\\'\\\\\\(\\\\\\)\\\\\\*\\\\\\+\\\\\\,\\\\\\;\\\\\\=]*?)");
        Pattern.compile("^(" + pattern + ")$", Pattern.CASE_INSENSITIVE);

        test(null);
        Map<String, Object> map0 = FormDataHelper.parse(
                "nome=davi&idade=23&enderecos[]=rua1&enderecos[]=rua2&telefone[0].ddd=11&telefone[0].numero=123123&telefone[1].ddd=12&telefone[1].numero=456456");
        Map<String, Object> map1 = FormDataHelper
                .parse("telefone[0].composicao.numbers[]=456456&pessoa.nome.primeiro=davi");
